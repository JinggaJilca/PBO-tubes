...
<% 
    // 1. Set default nama jika belum login
    String usernameNavbar = "User"; 
=======
<%@ page contentType="text/html" pageEncoding="UTF-8" %>

    <% String usernameNavbar=(String) request.getAttribute("username"); if (usernameNavbar==null ||
        usernameNavbar.trim().isEmpty()) { usernameNavbar="User" ; } String ctx=request.getContextPath(); %>
>>>>>>> origin/main

    // 2. Ambil object User dari Session
    User loggedInUser = (User) session.getAttribute("user");
    
    // 3. Jika user ada, ambil namanya
    if (loggedInUser != null) { 
        // Ubah getUsername() menjadi getName() jika variabel di model Anda bernama 'name'
        usernameNavbar = loggedInUser.getUsername(); 
