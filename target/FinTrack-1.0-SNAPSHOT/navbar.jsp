...
<% 
    ...
    if (userObj != null) {
        User navbarUser = (User) userObj;
        if (navbarUser.getUsername() != null && !navbarUser.getUsername().trim().isEmpty()) {
            usernameNavbar = navbarUser.getUsername();
        }
        
        // Ambil notifikasi
        NotificationDAO notificationDAO = new NotificationDAO();
        notificationCount = notificationDAO.getNotificationCountByUserId(navbarUser.getUserID());
    } 
%>
...
<nav class="navbar navbar-expand-lg navbar-custom py-3 text-white">
    <div class="container">
        <a class="navbar-brand" href="<%= ctx %>/dashboard">
            <img src="<%= ctx %>/images/FLogo.png" class="navbar-logo" alt="FinTrack Logo">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav gap-5 align-items-center">
                <li class="nav-item">
                    <a class="nav-link text-white px-3 d-flex align-items-center gap-2" href="<%= ctx %>/dashboard">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white px-3 d-flex align-items-center gap-2" href="<%= ctx %>/wallet">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white px-3 d-flex align-items-center gap-2" href="<%= ctx %>/transaction">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M11.025 21v-2.15q-1.325-.3-2.287-1.15t-1.413-2.4l1.85-.75q.375 1.2 1.113 1.825t1.937.625q1.025 0 1.738-.462t.712-1.438q0-.875-.55-1.387t-2.55-1.163q-2.15-.675-2.95-1.612t-.8-2.288q0-1.625 1.05-2.525t2.15-1.025V3h2v2.1q1.25.2 2.063.913t1.187 1.737l-1.85.8q-.3-.8-.85-1.2t-1.5-.4q-1.1 0-1.675.488T9.825 8.65q0 .825.75 1.3t2.6 1q1.725.5 2.613 1.588t.887 2.512q0 1.775-1.05 2.7t-2.6 1.15V21z" />
                        </svg>
                        Transaction
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white px-3 d-flex align-items-center gap-2" href="<%= ctx %>/budget">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5">
                                <path stroke-linecap="round" d="M20.943 16.835a15.76 15.76 0 0 0-4.476-8.616c-.517-.503-.775-.754-1.346-.986C14.55 7 14.059 7 13.078 7h-2.156c-.981 0-1.472 0-2.043.233c-.57.232-.83.483-1.346.986a15.76 15.76 0 0 0-4.476 8.616C2.57 19.773 5.28 22 8.308 22h7.384c3.029 0 5.74-2.227 5.25-5.165" />
                                ...
                                <path stroke-linecap="round" d="M13.627 12.919c-.216-.799-1.317-1.519-2.638-.98s-1.53 2.272.467 2.457c.904.083 1.492-.097 2.031.412c.54.508.64 1.923-.739 2.304c-1.377.381-2.742-.214-2.89-1.06m1.984-5.06v.761m0 5.476v.764" />
                            </g>
                        </svg>
                        Budget
                    </a>
    ...
    function confirmNavbarLogout() {
        new bootstrap.Modal(
            document.getElementById('navbarLogoutModal')
        ).show();
    }
    </script>
...
<div class="modal fade" id="navbarLogoutModal" tabindex="-1" aria-hidden="true">
