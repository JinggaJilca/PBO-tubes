                ...
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value">
                            Rp
                            <fmt:formatNumber value="${summary.totalBalance}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value">
                            Rp
                            <fmt:formatNumber value="${summary.totalEarnings}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </div>
                        ...
                        <small class="text-muted">
                            Bulan lalu:
                            Rp
                            <fmt:formatNumber value="${summary.lastMonthEarnings}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </small>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value">
                            Rp
                            <fmt:formatNumber value="${summary.totalSpending}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </div>
                        ...
                        <small class="text-muted">
                            Bulan lalu:
                            Rp
                            <fmt:formatNumber value="${summary.lastMonthSpending}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </small>
                ...
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <small class="text-muted">
                            Saldo bulan lalu:
                            Rp
                            <fmt:formatNumber value="${summary.lastMonthBalance}"
                                              type="number"
                                              groupingUsed="true"
                                              maxFractionDigits="0" />
                        </small>
                                ...
                                <div class="category-row">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="text-muted">
                                            Rp
                                            <fmt:formatNumber value="${category.totalAmount}"
                                                              type="number"
                                                              groupingUsed="true"
                                                              maxFractionDigits="0" />
                                        </span>
                                        ...
                                        <c:forEach var="monthly" items="${monthlySummary}">
                                            <tr>
                                                ...
                                                <td class="fw-semibold">
                                                    Rp
                                                    <fmt:formatNumber value="${monthly.totalIncome - monthly.totalExpense}"
                                                                      type="number"
                                                                      groupingUsed="true"
                                                                      maxFractionDigits="0" />
                                                </td>
