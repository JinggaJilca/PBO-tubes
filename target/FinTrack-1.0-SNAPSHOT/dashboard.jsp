...
<%
    ...
    List<RecentActivity> recentActivities = (List<RecentActivity>) request.getAttribute("recentActivities");
    List<CategorySpendingSummary> spendingOverview = (List<CategorySpendingSummary>) request.getAttribute("spendingOverview");
    CategorySpendingSummary largestCategory = (CategorySpendingSummary) request.getAttribute("largestCategory");
    Double averageExpenseObject = (Double) request.getAttribute("averageExpense");
    double averageExpense = 0;
    if (averageExpenseObject != null) averageExpense = averageExpenseObject;
    ...
    if (monthlyLabelsJson == null || monthlyLabelsJson.trim().isEmpty()) monthlyLabelsJson = "[]";
    if (monthlyIncomeJson == null || monthlyIncomeJson.trim().isEmpty()) monthlyIncomeJson = "[]";
    if (monthlyExpenseJson == null || monthlyExpenseJson.trim().isEmpty()) monthlyExpenseJson = "[]";
    if (categoryLabelsJson == null || categoryLabelsJson.trim().isEmpty()) categoryLabelsJson = "[]";
    if (categoryAmountJson == null || categoryAmountJson.trim().isEmpty()) categoryAmountJson = "[]";
    ...
    double lastMonthBalance = 0, lastMonthIncome = 0, lastMonthExpense = 0;
    if (summary != null) {
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <form action="<%= request.getContextPath() %>/DashboardExportServlet" method="GET" class="m-0">
                        <button type="submit" class="btn-date d-flex align-items-center gap-2">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value maskable"><%= rupiah.format(balance) %></div>
                        <hr>
                        <small class="text-muted">Last month : <span class="maskable"><%= rupiah.format(lastMonthBalance) %></span></small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value maskable"><%= rupiah.format(totalIncome) %></div>
                        <hr>
                        <small class="text-muted">Last month : <span class="maskable"><%= rupiah.format(lastMonthIncome) %></span></small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <hr>
                        <small class="text-muted">Last month : <span class="maskable"><%= rupiah.format(lastMonthExpense) %></span></small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card fintrack-card summary-card p-3">
                    <div class="card-body">
                        ...
                        <div class="summary-value maskable"><%= rupiah.format(totalExpense) %></div>
                        <small class="text-muted">From <span class="maskable"><%= rupiah.format(totalIncome) %></span></small>
                        ...
                        <div class="spending-mini-list">
                            <%
                                if (spendingOverview != null && !spendingOverview.isEmpty()) {
                                    ...
                                    for (int i = 0; i < max; i++) {
                                        ...
                                        if (i == 0) dotClass = "legend-orange";
                                        else if (i == 1) dotClass = "legend-yellow";
                            %>
                            <div class="spending-mini-item">
                                ...
                                <span class="maskable"><%= rupiah.format(category.getTotalAmount()) %></span>
                            </div>
                            <% } } else { %>
                            <div class="spending-mini-item">
                                <span class="text-muted">No spending data yet.</span>
                            </div>
                            <% } %>
                        </div>
                    </div>
                ...
                <div class="card fintrack-card activity-card p-4 activity-card-compact">
                    <div class="d-flex justify-content-between align-items-start mb-3 flex-wrap gap-2">
                        <div>
                            ...
                            <h3 class="chart-card-title maskable"><%= rupiah.format(totalExpense) %></h3>
                        </div>
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            <div class="legend-inline mb-0">
            ...
            <div class="col-12 col-lg-5">
                <div class="card fintrack-card activity-card p-4 activity-card-compact">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button type="button" class="btn-sortby">
                            <i class="bi bi-filter"></i> Sort by <i class="bi bi-chevron-down"></i>
                        </button>
                    </div>
                        ...
                        <table class="activity-table w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <% if (isIncome) { %>
                                            <span class="income-amount maskable">+ <%= rupiah.format(activity.getAmount()) %></span>
                                        <% } else { %>
                                            <span class="expense-amount maskable">- <%= rupiah.format(activity.getAmount()) %></span>
                                        <% } %>
                                    </td>
                                ...
                                <% } } else { %>
                                <tr>
                                    <td colspan="5" class="empty-data">No recent transactions.</td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
            ...
            <div class="col-12 col-md-4">
                <div class="card fintrack-card p-4 h-100">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="fw-bold text-dark mb-0">Highest Spending Category</h6>
                    </div>

                    <% if (largestCategory != null) { %>
                        <div class="summary-value mb-1 maskable"><%= largestCategory.getCategoryName() %></div>
                        <p class="mb-1 text-muted" style="font-size:0.82rem;">Total expense</p>
                        <h5 class="fw-bold mb-2 maskable"><%= rupiah.format(largestCategory.getTotalAmount()) %></h5>
                        <div class="progress" style="height:8px;border-radius:999px;background:#f3f4f6;">
                            <div class="progress-bar" role="progressbar"
                                style="width:<%= largestCategory.getPercentage() %>%;background:#dc2626;border-radius:999px;">
                            </div>
                        </div>
                        <small class="text-muted mt-1 d-block">
                            <span class="maskable"><%= String.format("%.1f", largestCategory.getPercentage()) %>%</span>
                            of total spending this month.
                        </small>
                    <% } else { %>
                        <div class="empty-data">No spending data this month.</div>
                    <% } %>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="card fintrack-card p-4 h-100">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="fw-bold text-dark mb-0">Average Expense</h6>
                    </div>
                    <div class="summary-value mb-2 maskable"><%= rupiah.format(averageExpense) %></div>
                    <small class="text-muted">Average amount per expense transaction this month.</small>

                    <div class="mt-3 pt-3" style="border-top:1px solid #f3f4f6;">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <small class="text-muted">vs Total Income</small>
                            <small class="fw-semibold maskable">
                                <%= totalIncome > 0 ? String.format("%.1f", (totalExpense / totalIncome) * 100) : "0.0" %>%
                            </small>
                        </div>
                        <div class="progress" style="height:6px;border-radius:999px;background:#f3f4f6;">
                            <div class="progress-bar" role="progressbar"
            ...
            <div class="col-12 col-md-4">
                <div class="card fintrack-card p-4 h-100">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="fw-bold text-dark mb-0">Category Breakdown</h6>
                    </div>

                    <% if (spendingOverview != null && !spendingOverview.isEmpty()) {
                        String[] barColors = {"#e05c3a","#d9a441","#8aab99","#2563eb","#9EDE04"};
                        int maxCat = Math.min(4, spendingOverview.size());
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span style="font-size:0.82rem;font-weight:600;color:#333;"><%= category.getCategoryName() %></span>
                            <span style="font-size:0.78rem;color:#888;" class="maskable">
                                <%= String.format("%.1f", category.getPercentage()) %>%
                            </span>
                        </div>
                        <div class="progress" style="height:7px;border-radius:999px;background:#f3f4f6;">
                            <div class="progress-bar" role="progressbar"
                    ...
                    <% } } else { %>
                    <div class="empty-data">No category data yet.</div>
                    <% } %>
                </div>
            </div>
