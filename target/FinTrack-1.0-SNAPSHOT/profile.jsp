            ...
            <body>
                ...
                <div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 9999;">
                    ...
                    <c:if test="${param.error == '1'}">
                        <div id="profileToast" class="toast align-items-center text-bg-danger border-0" role="alert">
                            <div class="d-flex">
                                <div class="toast-body">
                ...
                <div class="dashboard-header">
                    <div class="container">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <button type="button" class="btn-date d-flex align-items-center gap-2"
                    ...
                    <div class="card fintrack-card p-4 p-md-5">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <div class="profile-avatar-lg">
                                <img src="${pageContext.request.contextPath}/images/ProfilePicture.png"
                                    alt="Profile Picture">
                            </div>
                            <div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-6 col-md-3">
                                <p class="mb-1 text-muted"
                                    style="font-size: 0.78rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Username</p>
                                <p class="mb-0 fw-semibold" style="color: #002d26; font-size: 0.95rem;">
                                    ${profile.username}</p>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <p class="mb-1 text-muted"
                                    style="font-size: 0.78rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Email Address</p>
                                <p class="mb-0 fw-semibold" style="color: #002d26; font-size: 0.95rem;">${profile.email}
                                </p>
                            </div>
                            ...
                            <div class="col-12">
                                <div style="border-top: 1px solid #f3f4f6; margin-top: 8px; padding-top: 24px;"
                                    ...
                                    <button type="button" class="btn-trx-cancel d-flex align-items-center gap-2"
                                        style="color: #dc2626;" onclick="confirmLogout()">
                            ...
                            <form action="${pageContext.request.contextPath}/profile" method="POST">
                                <div class="modal-body trx-modal-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" name="fullName" class="trx-input"
                                                placeholder="Your full name" value="${profile.fullName}">
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" name="phoneNumber" class="trx-input"
                                                placeholder="e.g. 08123456789" value="${profile.phoneNumber}">
                                        </div>

                                        <div class="col-12 col-md-6">
                                            <label class="trx-label">Email Address</label>
                                            <input type="email" name="email" class="trx-input"
                                                placeholder="your@email.com" value="${profile.email}">
                                        </div>

                                        <div class="col-12">
                                            <label class="trx-label">Address</label>
                                            <textarea name="address" class="trx-input" rows="2"
                                    ...
                                    <div style="border-top: 1px solid #f3f4f6; margin: 24px 0 20px;">
                                        <p class="mb-0"
                                            style="font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #002d26; margin-top: 20px;">
                                            Change Password <span
                                                style="color: #aaa; font-weight: 400; text-transform: none; letter-spacing: 0;">(optional)</span>
                                        </p>
                                        <p class="text-muted mb-0" style="font-size: 0.8rem; margin-top: 4px;">Leave
                                            blank if you don't want to change your password.</p>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <p id="passwordMatchMsg" class="mb-0 mt-1"
                                                style="font-size: 0.78rem; display: none;"></p>
                                        </div>
