...
public class AddTransactionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = dashboardDAO.addTransaction(
                    userId,
                    accountId,
                    categoryId,
                    transactionName,
            ...
            if (success) {
                response.sendRedirect(request.getContextPath() + "/dashboard?success=add");
            } else {
                response.sendRedirect(request.getContextPath() + "/dashboard?error=add");
            }
