...
2. Buka folder dengan klik **File** ➡️ **Open Folder** atau tekan `(Ctrl + K + Ctrl + O)` ➡️ Pilih folder yang sudah di buat.
3. Buka Terminal Baru.
4. Ketik **git clone https://github.com/JinggaJilca/PBO-tubes** pada terminal, lalu tekan **Enter**.
...
5. Selanjutnya klik kanan pada project ➡️ tekan Run.
